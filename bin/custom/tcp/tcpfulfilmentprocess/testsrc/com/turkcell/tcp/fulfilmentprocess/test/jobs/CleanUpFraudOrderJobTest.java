 ...
 */
package com.turkcell.tcp.fulfilmentprocess.test.jobs;
...
import com.turkcell.tcp.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TcpFulfilmentProcessConstants.ORDER_PROCESS_NAME;
