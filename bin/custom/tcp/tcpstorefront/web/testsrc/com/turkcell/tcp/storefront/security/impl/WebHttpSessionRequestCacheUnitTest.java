...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcpstorefront/electronics/en",
						"https://electronics.local:9002/tcpstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcpstorefront/electronics/en",
						"https://electronics.local:9002/tcpstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tcpstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/tcpstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tcpstorefront/electronics/en",
						"https://electronics.local:9002/tcpstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tcpstorefront",
						"https://electronics.local:9002/tcpstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tcpstorefront",
						"https://electronics.local:9002/tcpstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcpstorefront/electronics/en",
						"https://electronics.local:9002/tcpstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
