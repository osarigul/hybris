 ...
 */
package com.turkcell.tcp.core.suggestion;
...
import com.turkcell.tcp.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/tcpcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
