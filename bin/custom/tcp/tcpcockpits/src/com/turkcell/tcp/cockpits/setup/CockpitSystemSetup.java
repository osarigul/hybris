 ...
 */
package com.turkcell.tcp.cockpits.setup;
...
import com.turkcell.tcp.cockpits.constants.TcpCockpitsConstants;
 ...
 */
@SystemSetup(extension = TcpCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(TcpCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(TcpCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						TcpCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/tcpcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
