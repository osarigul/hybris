 ...
 */
package com.turkcell.tcp.test.setup;
...
import com.turkcell.tcp.test.constants.TcpTestConstants;
import com.turkcell.tcp.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TcpTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/tcptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/tcptest/import/reviews.impex");
			...
			importImpexFile(context, "/tcptest/import/cstickets.impex");
		}
	}
}
